...
export const taskConfigSchema = z.object({
  ...
  videoType: z.string().default('talking_head'),
  videoPlatform: z.string().default('youtube'),
  videoStyle: z.string().default('educational'),
  videoPresenterName: z.string().default(''),
  videoPresenterPersona: z.string().default(''),
  videoCTA: z.string().default('subscribe'),
  videoHookStyle: z.string().default('question'),
  videoTone: z.string().default('casual'),
  videoSpecialElements: z.string().default(''),
  videoLanguageStyle: z.string().default('casual'),
  ...
  botSystemPrompt: z.string().default(''),
  botPersonaDetail: z.string().default(''),
  botLanguage: z.string().default('Bahasa Indonesia'),
  botAudience: z.string().default(''),
  botAvoidTopics: z.string().default(''),
  docType: z.string().default('Standard Operating Procedure (SOP)'),
  docContext: z.string().default(''),
  docMode: z.string().default('generic'),
  docIsoKategori: z.string().default('smm'),
  docIsoJenis: z.string().default('manual_mutu'),
  docIsoStandar: z.string().default('iso_9001'),
  docIsoKlausul: z.string().default('4|||5|||6|||7|||8|||9|||10'),
  docIsoNomorDok: z.string().default(''),
  docIsoVersi: z.string().default('01'),
  docIsoTanggal: z.string().default(''),
  docNamaOrg: z.string().default(''),
  docDepartemen: z.string().default(''),
  docLingkup: z.string().default(''),
  docDetailLevel: z.string().default('komprehensif'),
  docBahasa: z.string().default('id'),
  docCustomInstruksi: z.string().default(''),
  docGenericKategori: z.string().default('tender'),
  docGenericJenis: z.string().default(''),
  docGenericTujuan: z.string().default(''),
  docGenericPihak: z.string().default(''),
  docGenericFormat: z.string().default('mix'),
  docPaket: z.string().default('tender_lengkap'),
  docNamaDokumen: z.string().default(''),
  docDeskripsi: z.string().default(''),
  docNilaiKontrak: z.string().default(''),
  docPeriode: z.string().default(''),
  docLokasiProyek: z.string().default(''),
  docPenanggungJawab: z.string().default(''),
  docKonteksLain: z.string().default(''),
  packType: z.string().default('ebook_author'),
  packAiTool: z.string().default('chatgpt'),
  packNumPrompts: z.string().default('5'),
  packGoal: z.string().default(''),
  packTechniques: z.string().default('chain_of_thought|||persona_acting'),
  packOutputStyle: z.string().default('structured'),
  packDepth: z.string().default('intermediate'),
  packLanguage: z.string().default('indonesia'),
  packCustomContext: z.string().default(''),
  packCategory: z.string().default('content'),
  ...
  appProblem: z.string().default(''),
  appKeyFeatures: z.string().default(''),
  ...
  quizScope: z.string().default('komprehensif'),
  quizBabRef: z.string().default(''),
  quizTypeConfig: z.string().default(''),
  quizFormat: z.string().default('plain'),
  quizIncludeKey: z.string().default('ya'),
  quizDuration: z.string().default('30 menit'),
  quizContext: z.string().default(''),
  ...
  podcastHostPersona: z.string().default(''),
  podcastGuestPersona: z.string().default(''),
  podcastInteractionStyle: z.string().default(''),
  podcastKnowledgeDepth: z.string().default('deep'),
  podcastKnowledgeFocus: z.string().default('semua'),
  podcastKeyQuestions: z.string().default(''),
  podcastEnergyLevel: z.string().default('moderate'),
  podcastLanguageStyle: z.string().default('semiformal'),
  podcastSpecialSegments: z.string().default(''),
  ...
  audiobookNarratorPersona: z.string().default(''),
  audiobookLanguageStyle: z.string().default('semiformal'),
  audiobookListeningContext: z.string().default('general'),
  audiobookChapterRef: z.string().default(''),
  audiobookOpeningStyle: z.string().default('hook'),
  audiobookClosingStyle: z.string().default('summary'),
  audiobookSpecialElements: z.string().default(''),
  audiobookMusicStyle: z.string().default('instrumental'),
